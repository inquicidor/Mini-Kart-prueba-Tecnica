...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        private void RotatateToCrashs()
        {
            transform.Rotate(200 * Time.deltaTime, 200 * Time.deltaTime, 200 * Time.deltaTime);
        }
        ...
        float baseSpeed;
        public void SpeedPower(float speedAdd) {
            baseSpeed = baseStats.TopSpeed;
            baseStats.TopSpeed = speedAdd;
